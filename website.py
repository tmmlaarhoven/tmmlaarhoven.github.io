...
#for V in []:
	for E in Events:		
		...
		for O in Orders:
			...
			if not os.path.exists(f"{PathRank}{V}\\{E}\\{V}_{E}_ranking.json") or not os.path.exists(f"{PathRank}{V}\\{E}\\{V}_{E}_ranking{O}.ndjson"):
				continue
			if O == "_average":
			...
			with open(f"{PathWeb}{V}\\{E}\\{Orders[O]}", "w") as ofile:			
				...
				with open(f"{PathRank}{V}\\{E}\\{V}_{E}_ranking{O}.ndjson", "r") as rf:
					for Line in rf:
...
for V in Variants:
	for E in Events:		
		...
		with open(f"{PathWeb}{V}\\{E}\\stats.html", "w") as ofile:			
			...
			ofile.write(f"\t\t<img src='figures/{V}_{E}_players.png'>\n")
			ofile.write(f"\t\t<img src='figures/{V}_{E}_games.png'>\n")
			ofile.write(f"\t\t<img src='figures/{V}_{E}_points.png'>\n")
			ofile.write(f"\t\t<img src='figures/{V}_{E}_moves.png'>\n")
			ofile.write(f"\t\t<img src='figures/{V}_{E}_rating.png'>\n")
			ofile.write(f"\t\t<img src='figures/{V}_{E}_berserk.png'>\n")
			ofile.write(f"\t\t<img src='figures/{V}_{E}_topscore.png'>\n")
			ofile.write(f"\t\t<img src='figures/{V}_{E}_results.png'>\n")
			ofile.write("\t\t</figure>\n")
			ofile.write("\t\t</th>\n")
			ofile.write("\t</thead>\n")	
			#ofile.write("\t<tfoot>\n")
