...
def MakePlot(V, E, Plot):
	...
	# Skip if no data
	if not os.path.exists(PathRank + Folder(V, E) + V + "_" + E + "_ranking.json") or not os.path.exists(PathRank + Folder(V, E) + V + "_" + E + "_ranking.ndjson"):
	...
	with open(PathRank + Folder(V, E) + V + "_" + E + "_ranking.ndjson", "r") as DataFile:
...
def UserPlot(V, E, Plot):
	...
	TopPlayers = []
	with open(PathRank + Folder(V, E) + Prefix(V, E) + "ranking_" + Plot + ".ndjson", "r") as RankFile:
