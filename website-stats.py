	...
	for ev in event:		
		...
		for order in ord:
			...
			with open(fpathweb + mo + "\\" + ev + "\\" + ord[order], "w") as ofile:			
				...
				ofile.write("\t</tr>\n")
				ofile.write("\t<tr>\n")
				ofile.write("\t\t<th colspan='10' class='sort'><a class='sort' href='stats.html'>Stats</a> &middot; Show rankings sorted by: &nbsp;&nbsp;&nbsp;\n")
...
for mo in mode:
	for ev in event:		
		if not os.path.exists(frpath + mo + "\\" + ev + "\\" + mo + "_" + ev + "_ranking.json"):
			continue
		with open(fpathweb + mo + "\\" + ev + "\\stats.html", "w") as ofile:			
			ofile.write("<!DOCTYPE html>\n")
			ofile.write("<html lang='en-US'>\n")
			ofile.write("<!-- Rankings built using the Lichess API (https://lichess.org/api) and some manual (python-based) tournament scraping -->\n")
			ofile.write("<head>\n")
			...
			for index, mod in enumerate(moord):
				if os.path.exists(frpath + mod + "\\" + ev + "\\" + mod + "_" + ev + "_ranking.json"):
					ofile.write("\t\t\t &middot; <a class='" + ("active" if (mo == mod) else "mode") + "' href='../../" + mod + "/" + ev + "/stats.html'><span style='font-family: lichess' title='" + moord[mod] + "'>" + moordicon[mod] + "</span></a>\n")
				else:
					ofile.write("\t\t\t &middot; <a class='" + ("active" if (mo == mod) else "mode") + "' href='../../" + mod + "/all/stats.html'><span style='font-family: lichess' title='" + moord[mod] + "'>" + moordicon[mod] + "</span></a>\n")
			ofile.write("\t\t</th>\n")
			ofile.write("\t</tr>\n")
			ofile.write("\t<tr>\n")
			ofile.write("\t\t<th colspan='10' class='type'>\n")
			...
			for eve in evord:
				if os.path.exists(frpath + mo + "\\" + eve + "\\" + mo + "_" + eve + "_ranking.json"):
			...
			ofile.write("\t\t<img src='" + mo + "_" + ev + "_players.png'>\n")
			ofile.write("\t\t<img src='" + mo + "_" + ev + "_games.png'>\n")
			ofile.write("\t\t<img src='" + mo + "_" + ev + "_moves.png'>\n")
			ofile.write("\t\t<img src='" + mo + "_" + ev + "_rating.png'>\n")
			ofile.write("\t\t<img src='" + mo + "_" + ev + "_berserk.png'>\n")
			ofile.write("\t\t<img src='" + mo + "_" + ev + "_topscore.png'>\n")
			ofile.write("\t\t<img src='" + mo + "_" + ev + "_results.png'>\n")
			ofile.write("\t\t</figure>\n")
			ofile.write("\t\t</th>\n")
			ofile.write("\t</thead>\n")	
			#ofile.write("\t<tfoot>\n")
