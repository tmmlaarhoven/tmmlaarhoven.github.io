...
def BuildIndexPage():
	...
	with open("E:\\lichess\\tmmlaarhoven.github.io\\lichess\\rankings\\index.html", "w") as File:
		...
		File.write("<meta property='og:description' content='Statistics and rankings built from official Lichess arenas, ranging from hourly bullet arenas to titled arenas to bundesliga events. See who scored the most tournament victories, who played in the most events, which arenas had the largest number of participants, who holds the all-time records of the highest score for each type of arena, and much more!' />\n")
